...
/** Step 4 of the CAP flow. Pool × dept step-down matrix. Columns are the
 *  MatrixDeptCodes; cells come from the step-down engine's recomputed
 *  distribution — always engine-driven, regardless of whether per-receiver
 *  amounts were imported. Receiver imports still feed the engine via the
 *  driver matrix; this view always reports what the engine computed. */
