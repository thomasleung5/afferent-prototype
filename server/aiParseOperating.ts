...
- Department inclusion logic:
  ...
  * SKIP every row whose department is clearly outside the fee-supported departments above: Library, City Manager, HR, IT (unless directly billed to a fee-supported division), etc. Include City Clerk/Admin or Finance rows only when they relate to fee-supported services such as records/copies, marriage services, utility billing, payment processing, research fees, or business licenses.
